...
import amazon.strategy.CreditCardPaymentStrategy;
import amazon.strategy.UPIPaymentStrategy;
...
public class AmazonDemo {
    public static void main(String[] args) {
      ...
      //  Product giftWrappedBook = new GiftWrapDecorator(book);
        ...
        System.out.printf("Alice's cart total: $%.2f%n", aliceCart.calculatePrice());
