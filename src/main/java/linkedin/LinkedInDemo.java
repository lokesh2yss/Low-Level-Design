...
public class LinkedInDemo {
    public static void main(String[] args) {
        ...
        Member alice = new Member.Builder("Alice", "alice@example.com")
                ...
                .addExperience(new Experience("Sr. Software Engineer", "Google", 2018, 2022))
                .addExperience(new Experience("Software Engineer", "Microsoft", 2014, 2015))
        ...
        Member bob = new Member.Builder("Bob", "bob@example.com")
                ...
                .addExperience(new Experience("Product Manager", "Stripe", 2020, 2025))
        ...
        system.sendConnectionRequest(alice, charlie);
