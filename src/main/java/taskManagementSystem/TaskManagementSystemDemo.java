...
import taskManagementSystem.entities.TaskList;
import taskManagementSystem.entities.TaskManagementSystem;
...
class TaskManagementSystemDemo {
    public static void main(String[] args) {
        ...
        List<Task> filteredTasks = taskManagementSystem.listTaskByStatus(TaskStatus.TO_DO);
        System.out.println("\nTODO Tasks:");
